...
const Matrix = ({data}) => {
  ...
  return (
    <Box
      ...
      pad="medium"
    >
      <Heading textAlign="center">Memory Matrix</Heading>
      ...
      <Text >
        ...
        use to associate with random information. For example, if I had a list of ten items to remember,
        ...
        that involved dice with a lawn-mower. When it comes to recalling the tenth item, I immediately summon 'dice' and then
        that leads me to my imaginary scene involving the dice and the lawnmower.
      </Text>
      <Heading level="3" margin={{vertical: 'large'}}>Where do I start?</Heading>
      <Text>
        The problem is that this system requires us to remember 100 words before we can begin to use it.
        However, there is a system to remember the system. The first thing you need to do is go to the 'Number Sounds' page.
        You need to learn the sounds (not necessarily the letters) that are associated with each number from 0-9.
        If you expand the panels for each number, a suggestion is given about how to remember each one. Once you have remembered
        ...
        Once you have remembered all the sounds for the numbers, go to the 'Setup' page where you can pick from a suggested list of options for each word,
        or you can add your own. Once you have gone through the whole list of numbers 0-99, you can go to the 'Matrix' page and test yourself.
      ...
      <Heading level="3" margin={{vertical: 'large'}}>Device/browser consistency</Heading>
      <Text>
        ...
        issues arise because no data is taken. The downside of that is that if you customise the words, or select a word other than the
